...
My primary research interests lie in *building machine learning models that remain robust and efficient when deployed in real application contexts*. Revolving around this goal, I recently focus on *Computer Vision and AI-aided Science*, studying the following topics:  
